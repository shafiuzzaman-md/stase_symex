...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Build fails** – `undefined reference`, “conflicting types” …  | 1. Add a *stub* for functions that require external environment insteractions: ```EFI_STATUS EFIAPI UnusedProtocol (VOID) { return true ;}``` <br>2. Put it **above `main()` in the driver**.<br> 3. Re‑run **Step 3**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
