...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Build fails** – `undefined reference`, “conflicting types” …  | 1. Add a *stub* for every uninteresting function: ```EFI_STATUS EFIAPI UnusedProtocol (VOID) { return EFI_UNSUPPORTED;}``` <br>2. Put it **above `main()` in the driver**.<br> 3. Re‑run **Step 3**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
